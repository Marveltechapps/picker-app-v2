...
import { fetchPickerTerms, type LegalDocument } from "@/services/legal.service";
...
export default function TermsConditionsScreen() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = await fetchPickerTerms();
      setDoc(data);
    } catch (e) {
      const message =
      ...
      {loading ? (
        ...
        <>
          ...
          <View style={styles.footer}>
            <PrimaryButton title="I Agree" onPress={() => router.back()} />
          </View>
        </>
      ) : null}
    </View>
